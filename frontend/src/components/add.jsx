...
export default function Add(){
  ...
  const add_employee = async()=>{
    ...
    const url = "https://localhost:44330/api/chofers_helpers?type="+type;
    try{ 
  ...
  return(
	...
	<option value="0">Por favor seleccione que roll cumple este empleado.</option>
	...
	<div class="input">
	  <select className="form-select" onChange={(event)=>{setCargo_type(event.target.value);}} >
	...
	<div class="input">
	  <select className="form-select" onChange={(event)=>{setChofer(event.target.value);}} >
	...
	<div class="input">
	  <select className="form-select" onChange={(event)=>{setHelper(event.target.value);}} id="" name="">
